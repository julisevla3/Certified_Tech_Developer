...
//     let div = container1.querySelector('div')

    

//     container1.removeChild(div);
  
// }

// let felinos = [nome:tigre]
...
// let h5ElementoTextual = document.createTextNode("Estou aqui")
// h5.appendChild(h5ElementoTextual);

// let container1 = document.getElementById('container1');

// console.log(container1);

// container1.appendChild(h5);

//  console.log(h5.parentElement);
...
// // container2.firstElementChild.remove() REMOVER O PRIMEIRO
// // container2.lastElementChild.remove()REMOVER O ULTIMO
// // container2.removeChild(listaFelinos[0])REMOVER A LOCAÇÃO
// let novaDiv = document.createElement('div');

// novaDiv.innerHTML = "<h1> Novo elemento </h1>"

// container2.insertBefore(novaDiv, )
